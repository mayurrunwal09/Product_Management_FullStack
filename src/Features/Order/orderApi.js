...
// import { Base_Url, apiExtension, Get_All_Order, Update_Order, Create_Order, Delete_Order } from '../../Component/BaseUrl';
...
//   try {
//     const response = await api.put(`${Update_Order}/${orderId}`, updatedOrderData);
//     return response.data;
//   } catch (error) {
//     throw error;
//   }
...
//   try {
//     const response = await api.delete(`${Delete_Order}?Id=${orderId}`);
//     return response.data;
//   } catch (error) {
//     throw error;
//   }
...
export const deleteOrder = async (productId) => {
  try {
    const response = await api.delete(`https://localhost:44395/api/Order/DeleteOrder?Id=${productId}`);
